...
> 2026-09-21 需求更新：标注员侧采用无感质检体验。工作台、提交/释放提示、错误弹窗和个人历史均使用普通标注文案；本人复标记录并入普通提交历史，质量状态与裁定信息仅在管理员侧展示。以下原计划中关于独立标识、专用历史标签及结果提示的要求由此更新替代，详见 `cross-annotation-quality-frontend-development-report.md` 的“标注员无感质检”章节。
